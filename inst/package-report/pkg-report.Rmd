...
```{r functions_calls, echo = FALSE, comment = "", message = FALSE}
...
corrplot::corrplot(pkgreviewr::rev_args(params$pkgdir)$arg_map, method = 'square')
```
...
```{r cloc, echo = FALSE, eval = Sys.which("perl") != ''}
