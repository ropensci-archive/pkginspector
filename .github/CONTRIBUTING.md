# Contributing to pkginspector

This outlines how to propose a change to __pkginspector__. For more detailed info about contributing to this, and other __pkginspector__ packages, please see the [**development contributing guide of the tidyverse**](https://rstd.io/tidy-contrib) (wherever you read __tidyverse__ think __pkginspector__).
...
See tidyverse [development contributing guide](https://rstd.io/tidy-contrib) for further details (wherever you read __tidyverse__ think __pkginspector__).
