...
#     arg_info <- rev_args(system.file('viridisLite', package = 'revtools', mustWork = TRUE))
#     arg_info_exported <- rev_args(system.file('viridisLite', package = 'revtools', mustWork = TRUE), exported_only = TRUE)
...
#     degree_df <- rev_calls(system.file('viridisLite', package = 'revtools', mustWork = TRUE))
